...
execute if score #remaining br.sec_left matches ..0 if score #phase br.phase matches 1 run return run function br:start_pvp
execute if score #remaining br.sec_left matches ..0 if score #phase br.phase matches 2 run return run function br:start_sudden_death
