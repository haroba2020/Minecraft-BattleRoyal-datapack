...
scoreboard players set br.sec_left br.sec_left 600
execute if score #phase br.phase matches 1..3 run scoreboard players set br.sec_left br.sec_left 600
scoreboard players set sec_left br_sec_left 600
scoreboard players set br.sec_left br.sec_left 600
# --- Grace bossbar setup ---
...
execute store result bossbar br:grace value run scoreboard players get br.sec_left br.sec_left
bossbar set br:grace name {"text":"Grace","color":"yellow","extra":[{"score":{"name":"br.sec_left","objective":"br.sec_left"}},{"text":"s igjen"}]}
