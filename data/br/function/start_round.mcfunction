...
execute unless data storage br:settings center.dimension run return run tellraw @s {"text":"[BR] Kjør br:set_center i arenaen først.","color":"red"}
...
execute unless score #entered br.sys matches 1 run tellraw @s {"text":"[BR] Sjekk at arenaverdenen er lastet og innstillingene er gyldige.","color":"red"}
