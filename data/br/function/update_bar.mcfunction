...
execute if score #phase br.phase matches 2 run data modify storage br:ui text.label set value "Tid til Sudden death"
execute if score #phase br.phase matches 3 run data modify storage br:ui text.label set value "Sudden death"
